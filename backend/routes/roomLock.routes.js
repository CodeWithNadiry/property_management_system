...
import { create, getAll, getLocksUnAssigned, getRoomsUnAssigned, remove, update } from "../controllers/roomLock.controller.js";
...
router.patch('/edit-assign/:id', validateRequest(editAssignLockSchema), isAuth, update)
